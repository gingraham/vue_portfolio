<template>
  <div class="gallery">
    ...
    <div class="gallery-grid">
      <div v-for="(item, index) in filteredProjects" :key="index" :class="['gallery-items', itemAnimateClass(index)]">
...
export default {
  setup() {
    ...
    const itemAnimateClass = (index) => {
  return filteredProjects.value[index] ? 'item-animate' : '';
};
